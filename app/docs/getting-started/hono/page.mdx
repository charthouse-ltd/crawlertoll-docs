...
Don't want to wire this up by hand? Use the [Cloudflare Workers template](https://github.com/nhrzxxw9dn-web/crawlertoll-cloudflare-template) — one-click deploy via the "Deploy to Workers" button.
