...
Same surface as [Express](/docs/getting-started/express). See the [`@crawlertoll/fastify` README](https://github.com/nhrzxxw9dn-web/crawlertoll-fastify-js) for the full list.
