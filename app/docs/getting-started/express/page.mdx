export const metadata = {
  title: "Express",
  description: "Wire CrawlerToll into an Express 4 or 5 app in one line.",
};
...
8 supertest end-to-end tests, all green. See the [GitHub repo](https://github.com/nhrzxxw9dn-web/crawlertoll-express-js) for the full list.
