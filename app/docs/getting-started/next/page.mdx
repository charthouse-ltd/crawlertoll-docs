...
Skip the manual setup — use the [Vercel template](https://github.com/nhrzxxw9dn-web/crawlertoll-vercel-template). One-click "Deploy with Vercel" button gets you a working AI-crawler-aware Next 15 app in two minutes.
